...
import template.service.ServiceModule
...
trait MainModule
  ...
  private lazy val endpoints
      : ServerEndpoints = userApi.endpoints concatNel passwordResetApi.endpoints concatNel fsApi.endpoints concatNel mfApi.endpoints
